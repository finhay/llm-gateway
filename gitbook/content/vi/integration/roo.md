...
Tích hợp LLM Gateway với Roo AI Assistant để truy cập nhiều model AI qua một giao diện thống nhất.
...
Chọn từ các model LLM Gateway có sẵn:
...
### Connection Failed
- Xác minh LLM Gateway đang chạy: `curl http://localhost:20128/health`
