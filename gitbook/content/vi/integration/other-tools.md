...
LLM Gateway tương thích với mọi công cụ hỗ trợ format API OpenAI. Hướng dẫn này bao gồm pattern tích hợp tổng quát cho nhiều công cụ và ứng dụng tùy chỉnh.

## Tổng quan

LLM Gateway cung cấp API endpoint tương thích OpenAI hoạt động với:
...
Mọi công cụ tương thích OpenAI có thể kết nối đến LLM Gateway bằng các cài đặt sau:

**LLM Gateway cục bộ:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: any LLM Gateway model (cc/*, cx/*, glm/*, etc.)
```
...
**Vấn đề:** Không kết nối được đến LLM Gateway
```bash
...
**Giải pháp:**
- Xác minh LLM Gateway đang chạy
...
- Kiểm tra kết nối network đến LLM Gateway
