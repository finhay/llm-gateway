...
Chạy LLM Gateway trên máy cá nhân để phát triển và dùng cá nhân.

---

## 📦 Cài đặt

Cài đặt LLM Gateway toàn cục qua npm:
...
Khởi động LLM Gateway với một lệnh duy nhất:
...
Nhấn `Ctrl+C` trong terminal đang chạy LLM Gateway.
