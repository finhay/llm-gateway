...
Các vấn đề và giải pháp phổ biến khi dùng LLM Gateway.
...
1. **Auto-refresh (mặc định):**
   LLM Gateway tự refresh tokens. Đợi 30 giây rồi thử lại.
...
**Nguyên nhân:**
- LLM Gateway không chạy
- Port 20128 bị chặn
- Firewall chặn kết nối

**Giải pháp:**

1. **Khởi động LLM Gateway:**
   ```bash
   llm-gateway
   ```
...
- LLM Gateway bị crash
- Vấn đề cache browser

**Giải pháp:**

1. **Kiểm tra LLM Gateway có chạy không:**
   ```bash
   # Check process
