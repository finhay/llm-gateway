...
Ejecuta LLM Gateway en tu máquina local para desarrollo y uso personal.

---

## 📦 Instalación

Instala LLM Gateway globalmente vía npm:
...
Inicia LLM Gateway con un solo comando:
...
- **Directorio de datos**: `~/.llm-gateway`
...
Presiona `Ctrl+C` en la terminal donde LLM Gateway se está ejecutando.

```bash
# En la terminal ejecutando llm-gateway
^C  # Presiona Ctrl+C
```
