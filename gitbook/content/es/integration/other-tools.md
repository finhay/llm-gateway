...
LLM Gateway es compatible con cualquier herramienta que soporte el formato de API de OpenAI. Esta guía cubre patrones de integración genéricos para varias herramientas y aplicaciones personalizadas.

## Resumen

LLM Gateway proporciona un endpoint de API compatible con OpenAI que funciona con:
...
Cualquier herramienta compatible con OpenAI puede conectarse a LLM Gateway usando estas configuraciones:

**LLM Gateway local:**
```
Base URL: http://localhost:20128/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de LLM Gateway (cc/*, cx/*, glm/*, etc.)
```

**LLM Gateway en la nube:**
```
Base URL: https://llm-gateway.com/v1
API Key: your-api-key-from-dashboard
Model: cualquier modelo de LLM Gateway (cc/*, cx/*, glm/*, etc.)
```
...
**Problema:** No se puede conectar a LLM Gateway
```bash
# Verifica si LLM Gateway está corriendo
...
**Solución:**
- Verifica que LLM Gateway esté corriendo
...
- Verifica la conexión de red a LLM Gateway
