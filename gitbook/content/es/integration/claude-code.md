...
Integra LLM Gateway con Claude Code CLI para enrutar tus solicitudes de la API de Anthropic a través del sistema de enrutamiento inteligente de LLM Gateway.
...
Claude Code soporta los siguientes aliases de modelos que mapean a modelos de LLM Gateway:
...
1. Verifica que el nombre del modelo coincida con tu configuración de LLM Gateway
...
```bash
export ANTHROPIC_BASE_URL="https://llm-gateway.com"
```

Asegúrate de haber configurado tu API key en el dashboard en la nube de LLM Gateway.
