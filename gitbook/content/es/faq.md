...
Preguntas comunes sobre LLM Gateway.

---

## ¿Qué es LLM Gateway?

**LLM Gateway es un router de modelos de IA que maximiza el valor de tu suscripción y minimiza los costos.**
...
**LLM Gateway usa una estrategia de precios de 3 niveles:**
...
## ¿LLM Gateway es gratis?

**Sí, LLM Gateway en sí es 100% gratis y open source.**
...
**¡Sí! Esta es la característica principal de LLM Gateway.**
...
**LLM Gateway rastrea la cuota en tiempo real para todos los proveedores:**
...
## ¿Puedo auto-hospedar LLM Gateway?

**¡Sí! LLM Gateway soporta múltiples opciones de despliegue:**
...
- `DATA_DIR` - Ruta de almacenamiento de la base de datos (por defecto: `~/.llm-gateway`)
...
**Sí, LLM Gateway prioriza la seguridad y privacidad:**

**Almacenamiento local:**
- Todos los datos se almacenan localmente en `~/.llm-gateway` (o `DATA_DIR` personalizado)
- No se envían datos a los servidores de LLM Gateway
...
- Respalda `~/.llm-gateway` antes de actualizaciones mayores
...
- **Documentación:** [llm-gateway.com/docs](https://llm-gateway.com/docs)
