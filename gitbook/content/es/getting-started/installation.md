...
Guía detallada de instalación de LLM Gateway con consejos de solución de problemas.
...
Instala LLM Gateway globalmente para usar desde cualquier lugar:
...
- ✅ Comando simple: `llm-gateway`
- ✅ Auto-actualizaciones con `npm update -g llm-gateway`
...
3. Se crea el directorio de datos en `~/.llm-gateway`
...
**Ubicación por defecto:** `~/.llm-gateway`
...
**Problema:** LLM Gateway usa demasiada RAM
...
nano ~/.bashrc  # o ~/.zshrc
# Eliminar exports relacionados con llm-gateway
```
...
- **Sitio web**: [llm-gateway.com](https://llm-gateway.com)
