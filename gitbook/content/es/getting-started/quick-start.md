...
Pon en marcha LLM Gateway en 5 minutos y comienza a enrutar solicitudes de IA de forma inteligente.
...
Apunta tu herramienta de codificación a LLM Gateway:
...
Settings → Models → Advanced:
  ...
  OpenAI API Key: [desde el dashboard de llm-gateway]
