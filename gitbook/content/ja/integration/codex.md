...
LLM GatewayをOpenAI Codex CLIと統合し、OpenAI APIリクエストをLLM Gatewayのインテリジェントルーティングシステム経由でルーティングします。
...
1. LLM GatewayダッシュボードでAPIキーが正しいか確認
...
1. モデル名がLLM Gateway設定と一致するか確認
2. LLM GatewayダッシュボードでOpenAIプロバイダー接続がアクティブか確認
