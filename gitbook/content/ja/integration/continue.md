...
LLM GatewayをContinue拡張機能と統合し、Visual Studio Codeに直接AIアシスタンスを導入します。

## 前提条件

- Visual Studio Codeがインストール済み
- VSCodeマーケットプレイスからContinue拡張機能がインストール済み
- [ダッシュボード](https://llm-gateway.com/dashboard)からのLLM Gateway APIキー
- LLM Gatewayが動作中 (ローカルまたはクラウド)
