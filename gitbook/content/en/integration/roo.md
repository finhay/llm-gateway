...
Integrate LLM Gateway with Roo AI Assistant to access multiple AI models through a unified interface.
...
Choose from available LLM Gateway models:
...
### Connection Failed
- Verify LLM Gateway is running: `curl http://localhost:20128/health`
- Check API key is correct
- Ensure Base URL includes `/v1` suffix

### Model Not Available
- Check model name matches exactly (case-sensitive)
- Verify model is enabled in your LLM Gateway plan
- Try a different model from the list

### Slow Responses
- Switch to faster models (haiku, flash)
- Check network connection
- Monitor LLM Gateway logs for issues
