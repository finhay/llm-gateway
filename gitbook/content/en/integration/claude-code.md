...
Integrate LLM Gateway with Claude Code CLI to route your Anthropic API requests through LLM Gateway's intelligent routing system.
...
Claude Code supports the following model aliases that map to LLM Gateway models:
