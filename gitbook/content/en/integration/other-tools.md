...
LLM Gateway is compatible with any tool that supports the OpenAI API format. This guide covers generic integration patterns for various tools and custom applications.

## Overview

LLM Gateway provides an OpenAI-compatible API endpoint that works with:
...
Any OpenAI-compatible tool can connect to LLM Gateway using these settings:
...
- Check network connection to LLM Gateway
