...
Integrate LLM Gateway with OpenAI Codex CLI to route your OpenAI API requests through LLM Gateway's intelligent routing system.
...
LLM Gateway provides the following Codex models:
...
1. Verify your API key is correct in LLM Gateway dashboard
...
1. Verify the model name matches your LLM Gateway configuration
2. Check that the OpenAI provider connection is active in LLM Gateway dashboard
...
Make sure you have configured your API key in the LLM Gateway cloud dashboard.
