...
将 LLM Gateway 与 Claude Code CLI 集成,通过 LLM Gateway 的智能路由系统转发你的 Anthropic API 请求。
...
Claude Code 支持以下模型别名,映射到 LLM Gateway 模型:
...
确保已在 LLM Gateway 云端仪表盘中配置 API key。
