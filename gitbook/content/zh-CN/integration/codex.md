...
将 LLM Gateway 与 OpenAI Codex CLI 集成,通过 LLM Gateway 的智能路由系统转发你的 OpenAI API 请求。
...
1. 在 LLM Gateway 仪表盘中确认 API key 正确
...
2. 检查 LLM Gateway 仪表盘中 OpenAI 提供商连接是否激活
3. 确认连接的提供商中包含该模型
