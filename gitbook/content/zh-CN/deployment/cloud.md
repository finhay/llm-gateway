...
将 LLM Gateway 部署到 VPS 或 Docker,实现远程访问和生产使用。
...
| `DATA_DIR` | `~/.llm-gateway` | 数据库与数据存储路径 |
...
创建 `/etc/nginx/sites-available/llm-gateway`:
