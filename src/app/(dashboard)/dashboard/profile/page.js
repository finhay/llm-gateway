...
export default function ProfilePage() {
  ...
  const handleExportDatabase = async () => {
    ...
    try {
      ...
      anchor.href = url;
      anchor.download = `llm-gateway-backup-${stamp}.json`;
          ...
          <div className="flex flex-col gap-3 pt-4 border-t border-border">
            <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between p-3 rounded-lg bg-bg border border-border gap-2">
              <div>
                ...
                <p className="text-xs sm:text-sm text-text-muted font-mono break-all">~/.llm-gateway/db/data.sqlite</p>
              </div>
            </div>
          ...
          <div className="flex flex-col gap-4 mt-4">
            ...
            <div className="grid grid-cols-1 gap-4">
              <div className="flex flex-col gap-2">
                ...
                <Input
                  placeholder="https://auth.example.com/application/o/llm-gateway/"
              ...
              <div className="flex flex-col gap-2">
                ...
                <Input
                  placeholder="llm-gateway-dashboard"
