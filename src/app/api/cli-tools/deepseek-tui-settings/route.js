...
// Build TOML config for LLM Gateway (openai provider mode)
const buildLlmGatewayConfig = (baseUrl, apiKey, model) => {
...
// Detect LLM Gateway by checking if provider is "openai" and base_url points to localhost/127.0.0.1
...
export async function POST(request) {
    try {
        ...
        const newConfig = buildLlmGatewayConfig(baseUrl, apiKey || "sk_llm-gateway", model);
