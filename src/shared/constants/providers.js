...
export const FREE_PROVIDERS = {
  ...
  // === Synced from upstream 9router v0.5.55 ===
  "mimo-free": { id: "mimo-free", alias: "mmf", hidden: true, name: "MiMo Code Free", icon: "smart_toy", color: "#FF6900", textIcon: "MF", passthroughModels: true, noAuth: true, modelsFetcher: {"url":"https://models.dev/api.json","type":"mimo-free"} },
};
...
export const FREE_TIER_PROVIDERS = {
  ...
  // === Synced from upstream 9router v0.5.55 ===
  kimchi: { id: "kimchi", alias: "kimchi", name: "Kimchi", icon: "restaurant", color: "#FF521D", textIcon: "KC", website: "https://kimchi.dev", notice: {"signupUrl":"https://app.kimchi.dev"}, serviceKinds: ["llm","imageToText"], passthroughModels: true },
  "api-airforce": { id: "api-airforce", alias: "af", name: "API.airforce", icon: "flight", color: "#0EA5E9", textIcon: "AF", website: "https://api.airforce", notice: {"apiKeyUrl":"https://api.airforce"} },
  "kilo-gateway": { id: "kilo-gateway", alias: "kgw", name: "Kilo Gateway", icon: "login", color: "#8B5CF6", textIcon: "KG", website: "https://kilo.ai", notice: {"apiKeyUrl":"https://kilo.ai/dashboard?tab=apiKeys"} },
  poolside: { id: "poolside", alias: "poolside", name: "Poolside", icon: "water_drop", color: "#0EA5E9", textIcon: "PS", website: "https://poolside.ai", notice: {"apiKeyUrl":"https://platform.poolside.ai/api-keys"} },
};
...
export const APIKEY_PROVIDERS = {
  ...
  "perplexity-agent": { id: "perplexity-agent", alias: "perplexity-agent", name: "Perplexity Agent", icon: "travel_explore", color: "#20808D", textIcon: "PA", website: "https://www.perplexity.ai", notice: {"text":"Perplexity Agent API exposes GPT, Claude, Gemini, Grok, GLM, Kimi, and Sonar models through one OpenAI-compatible Responses API.","apiKeyUrl":"https://www.perplexity.ai/settings/api"}, serviceKinds: ["llm","webSearch"], passthroughModels: true, modelsFetcher: {"url":"https://api.perplexity.ai/v1/models","type":"openai"}, searchViaChat: {"defaultModel":"perplexity/sonar","endpoint":"https://api.perplexity.ai/v1/responses","pricingUrl":"https://docs.perplexity.ai/docs/agent-api/models"} },
  venice: { id: "venice", alias: "venice", name: "Venice AI", icon: "shield", color: "#DC2626", textIcon: "VE", website: "https://venice.ai", notice: {"text":"OpenAI-compatible. Private inference + uncensored models (Venice Uncensored, GLM, Qwen, DeepSeek, Llama).","apiKeyUrl":"https://venice.ai/settings/api"}, serviceKinds: ["llm","embedding","image"], passthroughModels: true, modelsFetcher: {"url":"https://api.venice.ai/api/v1/models","type":"openai"}, embeddingConfig: {"baseUrl":"https://api.venice.ai/api/v1/embeddings","authType":"apikey","authHeader":"bearer"}, imageConfig: {"baseUrl":"https://api.venice.ai/api/v1/images/generations"} },
  "vercel-ai-gateway": { id: "vercel-ai-gateway", alias: "vercel-ai-gateway", name: "Vercel AI Gateway", icon: "deployed_code", color: "#111827", textIcon: "VG", website: "https://vercel.com/ai-gateway", notice: {"text":"Unified OpenAI-compatible endpoint from Vercel. Use your AI Gateway API key, then pick models with provider/model IDs like anthropic/claude-sonnet-4.6 or openai/gpt-5.4.","apiKeyUrl":"https://vercel.com/dashboard/~/ai-gateway"}, serviceKinds: ["llm","embedding","image","imageToText","webSearch"], passthroughModels: true, modelsFetcher: {"url":"https://ai-gateway.vercel.sh/v1/models","type":"openai"}, searchViaChat: {"defaultModel":"openai/gpt-4o-mini","pricingUrl":"https://vercel.com/docs/ai-gateway/pricing"}, embeddingConfig: {"baseUrl":"https://ai-gateway.vercel.sh/v1/embeddings"}, imageConfig: {"baseUrl":"https://ai-gateway.vercel.sh/v1/images/generations"} },
  ...
  baidu: { id: "baidu", alias: "qianfan", name: "Baidu Qianfan", icon: "search", color: "#2932E1", textIcon: "BD", website: "https://cloud.baidu.com/product/qianfan.html", notice: {"apiKeyUrl":"https://console.bce.baidu.com/qianfan/ais/console/applicationConsole/application"} },
  bluesminds: { id: "bluesminds", alias: "bm", name: "BluesMinds", icon: "psychology", color: "#2563EB", textIcon: "BM", website: "https://bluesminds.com", notice: {"apiKeyUrl":"https://bluesminds.com"} },
  tencent: { id: "tencent", alias: "hunyuan", name: "Tencent Hunyuan", icon: "cloud", color: "#0052D9", textIcon: "HY", website: "https://cloud.tencent.com/product/hunyuan", notice: {"apiKeyUrl":"https://console.cloud.tencent.com/hunyuan/api-key"} },
  tokenrouter: { id: "tokenrouter", alias: "tokenrouter", name: "TokenRouter", icon: "hub", color: "#0EA5E9", textIcon: "TR", website: "https://www.tokenrouter.com", notice: {"text":"OpenAI-compatible gateway. 300+ models (OpenAI, Claude, Gemini, Qwen, DeepSeek, Kimi, GLM, dsb).","apiKeyUrl":"https://www.tokenrouter.com"}, serviceKinds: ["llm","embedding","image"], passthroughModels: true, modelsFetcher: {"url":"https://api.tokenrouter.com/v1/models","type":"openai"}, embeddingConfig: {"baseUrl":"https://api.tokenrouter.com/v1/embeddings","authType":"apikey","authHeader":"bearer"}, imageConfig: {"baseUrl":"https://api.tokenrouter.com/v1/images/generations"} },
