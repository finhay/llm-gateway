 ...
 * If llm-gateway's Anthropic→OpenAI conversion passes the input as a pre-parsed object,
...
/**
 * Read llm-gateway's OpenAI SSE response and re-encode it as AWS EventStream binary
      ...
      for (const line of lines) {
        ...
        if (delta.tool_calls) {
          ...
          for (const tc of delta.tool_calls) {
            ...
            // when llm-gateway's Anthropic→OpenAI conversion passes a pre-parsed object
 ...
 *   3. Forward to llm-gateway /v1/chat/completions (OpenAI SSE)
