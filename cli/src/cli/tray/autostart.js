...
const APP_LABEL = "com.llm-gateway.autostart";
 ...
 *   2. `process.argv[1]` if it's our cli.js — true when llm-gateway is currently
 ...
 * SIGTERM to the running process. When the running llm-gateway cli.js was itself
...
<dict>
    ...
    <string>/tmp/llm-gateway.log</string>
    <key>StandardErrorPath</key>
    <string>/tmp/llm-gateway.error.log</string>
</dict>
</plist>`;
...
function enableWindows(cliPath) {
  ...
  // `llm-gateway.cmd` lookup that depended on the npm prefix path.
